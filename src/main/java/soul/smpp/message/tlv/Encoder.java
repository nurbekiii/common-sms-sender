...
public interface Encoder {
     ...
     * @throws java.lang.ArrayIndexOutOfBoundsException if the encoding tries to write beyond the end of the byte
     *                                                  array.
     */
     ...
     * @throws java.lang.ArrayIndexOutOfBoundsException if the decoding tries to read beyond the end of the byte
     *                                                  array.
     */
