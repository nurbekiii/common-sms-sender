...
public class TLVTable implements java.io.Serializable {
     ...
     * @throws ie.omk.smpp.message.tlv.BadValueTypeException        if an attempt is made to set a value using a Java type that
     *                                                              is not allowed for that parameter type.
     * @throws ie.omk.smpp.message.tlv.InvalidSizeForValueException if the value's encoded length is outside the bounds allowed
     *                                                              for that parameter.
     */
