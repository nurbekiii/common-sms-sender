...
public final class Tag implements java.io.Serializable {
     ...
     * @throws ie.omk.smpp.message.tlv.TagDefinedException If a tag with integer value <code>tag</code> has already
     *                                                     been defined.
     */
     ...
     * @throws ie.omk.smpp.message.tlv.TagDefinedException if an attempt is made to define a tag with a integer value
