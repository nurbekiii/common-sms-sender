 ...
 * @version 1.0
 */
public class QueryLastMsgs extends soul.smpp.message.SMPPRequest {
    /**
     ...
     * @throws ie.omk.smpp.message.InvalidParameterValueException if the count is set outside the valid range.
     */
