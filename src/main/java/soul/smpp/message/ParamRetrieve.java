 ...
 * @version 1.0
 */
public class ParamRetrieve extends soul.smpp.message.SMPPRequest {
    /**
     ...
     * @throws ie.omk.smpp.message.InvalidParameterValueException if the parameter name is too long.
     */
