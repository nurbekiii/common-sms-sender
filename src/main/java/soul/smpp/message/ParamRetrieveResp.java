 ...
 * @version 1.0
 */
public class ParamRetrieveResp extends soul.smpp.message.SMPPResponse {
    /**
     ...
     *          characters)
     * @throws ie.omk.smpp.message.InvalidParameterValueException if the parameter value is too long.
     */
