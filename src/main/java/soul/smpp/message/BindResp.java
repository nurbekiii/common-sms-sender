 ...
 * @version 1.0
 */
public abstract class BindResp extends soul.smpp.message.SMPPResponse {
    /**
     * System Id
     */
     ...
     * @throws ie.omk.smpp.message.InvalidParameterValueException if the system id is too long.
     */
