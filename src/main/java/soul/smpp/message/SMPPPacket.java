...
import soul.smpp.message.tlv.TLVTable;
...
public abstract class SMPPPacket {
     ...
     *
     * @throws ie.omk.smpp.message.InvalidParameterValueException If <code>p</code> is not a valid value for the priority
     *                                                            flag.
     */
     ...
     * Set 'registered delivery' flag.
     *
     * @throws ie.omk.smpp.message.InvalidParameterValueException If <code>r</code> is not a valid value for the registered
     *                                                            delivery flag.
     */
     ...
     *
     * @throws ie.omk.smpp.message.InvalidParameterValueException If <code>rip</code> is not a valid value for the replace if
     *                                                            present flag.
     */
     ...
     *
     * @throws ie.omk.smpp.message.InvalidParameterValueException If the value passed is not a valid ESM class.
     ...
     *
     * @throws ie.omk.smpp.message.InvalidParameterValueException If the protocol ID supplied is invalid.
     * @see ie.omk.smpp.util.GSMConstants
     */
     ...
     *
     * @throws ie.omk.smpp.message.InvalidParameterValueException If the data coding supplied is invalid.
     * @see ie.omk.smpp.util.GSMConstants
     */
     ...
     * @throws ie.omk.smpp.message.InvalidParameterValueException If the message text is too long.
     ...
     * @throws ie.omk.smpp.message.InvalidParameterValueException If the message data is too long.
     */
     ...
     * @throws ie.omk.smpp.message.InvalidParameterValueException If the message data is too long.
     * @throws java.lang.ArrayIndexOutOfBoundsException           if start or len is less than zero or if the byte array length
     ...
     * @throws ie.omk.smpp.message.InvalidParameterValueException if the service type is too long.
     */
     ...
     * @throws ie.omk.smpp.message.InvalidParameterValueException If the message ID is invalid.
     */
     ...
     * @throws ie.omk.smpp.message.tlv.BadValueTypeException if the type of <code>value</code> is incorrect for the
     *                                                       <code>tag</code>.
     */
    ...
    public void readFrom(byte[] b, int offset) throws SMPPProtocolException {
        ...
        if (id != commandId) {
            ...
            throw new SMPPProtocolException(
                    "The packet on the input stream is not" + " the same as this packet's type.");
        }
        if (b.length < (offset + len)) {
            // not enough bytes there for me to read in, buddy!
            throw new SMPPProtocolException(
                    "Header specifies the packet length is longer" + " than the number of bytes available.");
        }
