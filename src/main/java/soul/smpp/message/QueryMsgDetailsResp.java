 ...
 * @version 1.0
 */
public class QueryMsgDetailsResp extends soul.smpp.message.SMPPResponse {
    /**
     ...
     * @return The current number of destination addresses (including the new
     * @throws ie.omk.smpp.message.InvalidParameterValueException if the distribution list name is too long.
     */
