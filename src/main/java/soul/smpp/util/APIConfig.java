...
public final class APIConfig extends Properties {
     ...
     * @throws ie.omk.smpp.util.PropertyNotFoundException if <code>property</code> is not found in the configuration.
     */
     ...
     * @throws ie.omk.smpp.util.PropertyNotFoundException     if <code>property</code> is not found in the configuration.
     * @throws ie.omk.smpp.util.InvalidConfigurationException if the value is not a valid short.
     */
     ...
     * @throws ie.omk.smpp.util.InvalidConfigurationException if the value is not a valid integer.
     */
     ...
     * @param property     the name of the property to retrive.
     * @param defaultValue the value to return if the property does not exist.
     * @throws ie.omk.smpp.util.InvalidConfigurationException if the value is not a valid long.
     */
     ...
     * @param defaultValue the value to return if the property does not exist.
     * @throws InvalidConfigurationException if the property has a value that cannot be parsed or
